...
def parse_args():
    ...
    parser.add_argument('--local_model', type=Path, default=Path("CSV/StackingClassifier.pkl"),
                        required=True, help='Path to Local model (default : gym_malware/envs/utils/gradient_boosting.pkl)')
...
def main():
    ...
    logging_setup("classifier_logs_" + str(date.today()) +
                  local_model.__class__.__name__ + ".log", args.log)
